...
function AstraLib:CreateWindow(options)
    ...
    function Window:CreateTab(options)
        ...
        function Tab:CreateSection(options)
            ...
            -- Section Header (styled like old labels - big and prominent)
            Create("TextLabel", {
                Name = "Header",
                Parent = SectionFrame,
                BackgroundTransparency = 1,
            ...
            -- LABEL (styled like old section headers - small and muted)
            ...
            function Section:CreateToggle(opt)
                ...
                Button.MouseEnter:Connect(function() 
                    ...
                    Tween(Button, {BackgroundColor3 = Value and Theme.AccentHover or Theme.CardHover}, TweenPresets.Quick)
                end)
                Button.MouseLeave:Connect(function() 
                    Tween(Circle, {Size = UDim2.new(0, 18 * Scale, 0, 18 * Scale)}, TweenPresets.Quick)
                    Tween(Button, {BackgroundColor3 = Value and Theme.Toggle or Theme.ToggleOff}, TweenPresets.Quick)
                end)
            ...
            function Section:CreateSlider(opt)
                ...
                Create("TextLabel", {Parent = Frame, BackgroundTransparency = 1, Position = UDim2.new(0, 0, 0, 0), Size = UDim2.new(1, -70 * Scale, 0, 20 * Scale), Font = Enum.Font.Gotham, Text = Name, TextColor3 = Theme.Text, TextSize = 13 * Scale, TextXAlignment = Enum.TextXAlignment.Left, ZIndex = ZIndex.Elements})
                ...
                Bg.InputBegan:Connect(function(input)
                    if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                        Sliding = true
                        Tween(Knob, {Size = UDim2.new(0, 18 * Scale, 0, 18 * Scale), BackgroundColor3 = Theme.Accent}, TweenPresets.Quick)
                    end
                end)
                Bg.MouseEnter:Connect(function()
                    Tween(Knob, {BackgroundColor3 = Theme.Accent}, TweenPresets.Quick)
                    Tween(Fill, {BackgroundColor3 = Theme.AccentHover}, TweenPresets.Quick)
                end)
                Bg.MouseLeave:Connect(function()
                    if not Sliding then
                        Tween(Knob, {BackgroundColor3 = Color3.new(1, 1, 1)}, TweenPresets.Quick)
                        Tween(Fill, {BackgroundColor3 = Theme.SliderFill}, TweenPresets.Quick)
                    end
                end)
                UserInputService.InputEnded:Connect(function(input)
                    if (input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch) and Sliding then
                        Sliding = false
                        Tween(Knob, {Size = UDim2.new(0, 14 * Scale, 0, 14 * Scale), BackgroundColor3 = Color3.new(1, 1, 1)}, TweenPresets.Quick)
                        Tween(Fill, {BackgroundColor3 = Theme.SliderFill}, TweenPresets.Quick)
                    end
                end)
                UserInputService.InputChanged:Connect(function(input)
            ...
            function Section:CreateDropdown(opt)
                ...
                function Dropdown:CloseDropdown()
                    ...
                    Tween(Button, {BackgroundColor3 = Theme.Input}, TweenPresets.Quick)
                ...
                function Dropdown:OpenDropdown()
                    ...
                    Tween(Button, {BackgroundColor3 = Theme.CardHover}, TweenPresets.Quick)
                end
            ...
            function Section:CreateInput(opt)
                ...
                Box.MouseEnter:Connect(function() 
                    if not Box:IsFocused() then 
                        ...
                        Tween(Box, {BackgroundColor3 = Theme.CardHover}, TweenPresets.Quick)
                    end 
                end)
                Box.MouseLeave:Connect(function() 
                    if not Box:IsFocused() then 
                        Tween(Box:FindFirstChild("UIStroke"), {Color = Theme.InputBorder}, TweenPresets.Quick)
                        Tween(Box, {BackgroundColor3 = Theme.Input}, TweenPresets.Quick)
                    end 
                end)
